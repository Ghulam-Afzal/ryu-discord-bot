...
async def initialize():
    ...
    await bot.db.execute("CREATE TABLE IF NOT EXIsTS shopData (guild_id int, user_id int, car int, house int, cat int, dog int, mansion int, PRIMARY KEY (guild_id, user_id))")
